...
def changePassword(request):
        if request.method == 'POST':
                ...
                #                <input name="email" value="{{question}}" class="input-lg form-control" readonly>
                ...
                #return Response(request, status=None, template_name=None, headers=None, content_type=None) #Response(request.body)
